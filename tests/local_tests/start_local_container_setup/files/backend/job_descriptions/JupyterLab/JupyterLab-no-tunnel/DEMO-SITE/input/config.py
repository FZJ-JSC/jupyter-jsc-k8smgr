...
c.SingleUserNotebookAppMixin.hub_api_url = "http://localhost:8000/hub/api"
c.SingleUserNotebookAppMixin.hub_activity_url = "http://localhost:8000/hub/api/users/_username_/activity"
