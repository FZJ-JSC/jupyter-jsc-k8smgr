...
c.SingleUserNotebookAppMixin.hub_api_url = "http://jupyterhub-<ID>.<NAMESPACE>.svc/hub/api"
c.SingleUserNotebookAppMixin.hub_activity_url = "http://jupyterhub-<ID>.<NAMESPACE>.svc/hub/api/users/_username_/activity"
