...
bind = "0.0.0.0:8443"
backlog = 2048
certfile = os.environ.get("GUNICORN_SSL_CRT", "/home/k8smgr/certs/k8smgr.crt")
keyfile = os.environ.get("GUNICORN_SSL_KEY", "/home/k8smgr/certs/k8smgr.key")
preload_app = True
...
pidfile = "/home/k8smgr/gunicorn.pid"
umask = 0
user = 1000
group = 100
tmp_upload_dir = None
